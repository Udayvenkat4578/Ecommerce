 ...
 e.preventDefault();
  ...
  return (
    ...
    <div class="border-r border-b border-l border-gray-200 lg:border-l-0 lg:border-t lg:border-gray-200 bg-white rounded-b lg:rounded-b-none lg:rounded-r flex flex-col justify-between leading-normal">
      <center>
      <h1 className='text-[#1a1c31c6] font-bold  mt-11 text-center text-2xl '>Good To See You Again</h1> 
        <h1 className='text-[#feb351] font-bold text-2xl mt-6'>Sign In</h1> 
...
<br></br>
        ...
        <button   onClick={signup} className=' font-extrabold text-white bg-[#feb351] px-4 py-2 rounded-lg mb-3'>Sign In</button>
<h1 className='text-sm px-8 mb-11 font-semibold'>By continuing, you agree to Amazon's Conditions of Use and Privacy Notice.</h1>
        </form>
      </center>
      </div>
      </div>
